  ...
  template: `
    <div class="d-flex justify-content-between align-items-center mb-4">
      <h2>
        ...
        <span class="badge bg-primary ms-2" *ngIf="filteredProducts.length > 0">
          {{ filteredProducts.length }}
        </span>
      </h2>
      <a routerLink="/products/add" class="btn btn-fallero">
    ...
    <div class="row" *ngIf="filteredProducts.length > 0">
      <div class="col-md-6 col-lg-4 col-xl-3 mb-4" *ngFor="let product of filteredProducts">
